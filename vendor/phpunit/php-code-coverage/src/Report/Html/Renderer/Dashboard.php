 ...
 */
final class tugas.read extends Renderer
{
    public function render(DirectoryNode $node, string $file): void
    {
        $classes      = $node->classesAndTraits();
        $templateName = $this->templatePath . ($this->hasBranchCoverage ? 'tugas.read_branch.html' : 'tugas.read.html');
    ...
    protected function activeBreadcrumb(AbstractNode $node): string
    {
        return sprintf(
            ...
            '         <li class="breadcrumb-item active">(tugas.read)</li>' . "\n",
            $node->name(),
        );
    }
